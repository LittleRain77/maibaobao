...
<table width="598" border="0" cellspacing="0" cellpadding="16" id="denglu_left_t1">
  <tr>
      <td width="77">用户名:</td>
      <td colspan="2"><input name="username" id="username" type="text" value="${sessionScope.user.uid }" /></td>
      <td width="201" class="denglu_left_t1_td"><span id="yonghumingtishi"></span></td>
  </tr>
  <tr>
      <td>登录密码：</td>
      <td colspan="2"><input name="pwd" id="pwd" type="password" value="${sessionScope.user.upass}"/></td>
      <td class="denglu_left_t1_td">忘记密码？</td>
  </tr>
  <tr>
      <td>验证码：</td>
      <td width="75" class="denglu_left_t1_td"><input name="unum" type="text" id="unum" /></td>
      <td width="102" class="denglu_left_t1_td"><img src= "valcode.jsp"  width="54" height="29" onclick=this.src=this.src+'?' /></td>
      <td class="denglu_left_t1_td"><span id="yanzhengmatishi"  >换一张？ 请点击图片</span></td>
  </tr>
  <tr>
     <td colspan="2" align="right" ><input type="checkbox" name="seven" value="1" style="width: 19px; height: 13px;"/>七天免登陆</td>
     <td colspan="2" align="left"><input type="checkbox" style="width: 19px; height: 13px;"/>自动登录</td>
  </tr>
